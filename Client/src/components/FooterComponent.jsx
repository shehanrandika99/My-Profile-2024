...
function FooterComponent() {
    return (
        <div>
            <footer
                class="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white bg-black">
                ...
                <div class="w-full bg-black/5 p-4 text-center">
                    © 2024 Copyright:
                    <a href="https://tw-elements.com/">Developed and Designed by Shehan Randika</a>
                </div>
            </footer>
        </div>
    )
